...
-- CreateIndex
CREATE INDEX "products_sale_campaign_id_idx" ON "products"("sale_campaign_id");
...
-- CreateIndex
CREATE INDEX "order_items_product_reference_idx" ON "order_items"("product_reference");
...
-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_sale_campaign_id_fkey" FOREIGN KEY ("sale_campaign_id") REFERENCES "sale_campaigns"("id") ON DELETE SET NULL ON UPDATE CASCADE;
